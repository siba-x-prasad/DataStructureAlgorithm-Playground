...
//            array[i] =
     ...
     * @param word1
     * @param word2
     * @return ["ab", "c"], word2 = ["a", "bc"]
     */
    private static boolean arrayStringsAreEqual(String[] word1, String[] word2) {
        String word1Sentence = String.join("", word1);
        String word2Sentence = String.join("", word2);
        return word1Sentence.equalsIgnoreCase(word2Sentence);
    }
    ...
    private static int[][] largestLocal(int[][] grid) {
        ...
        for (int i = 0; i < grid[0].length - 2; i++) {
            ...
            for (int j = 0; j < grid.length - 2; j++) {
                ...
                System.out.println(maxRowItem);
                resultArray[i][j] = maxRowItem;
            }
        }
        return resultArray;
    }
