...
public class HashCodeExample {
    int id;
    String name;
    HashCodeExample(int id, String name){
        this.id = id;
        this.name = name;
    }
